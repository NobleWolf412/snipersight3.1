...
EXPECTED = {
    ...
    "chart_insight": "chart-insight-v0.3-draft",
    "research": "research-v0.1-draft",
    "order_block": "order-block-v0.1-draft",
    # structure-sequence-v0.2: order judged on the break's real confirmation;
    # block bounds recorded so a setup links through its zone.
    "structure_sequence": "structure-sequence-v0.2-draft",
    "stoch_rsi": "stoch-rsi-v0.1-draft",
    "hidden_divergence": "hidden-divergence-v0.1-draft",
    "open_interest": "open-interest-v0.1-draft",
    # open-interest-signal-v0.2: confirmed at collection, not the scan clock.
    "open_interest_signal": "open-interest-signal-v0.2-draft",
    "research_snapshot": "research-snapshot-v0.2-draft",
    "research_read_model": "research-observation-v0.2-draft",
    "research_evidence": "research-evidence-v0.2-draft",
...
CONSUMERS = {
    ...
    "regimeread": ("setup",),
    # Fact-level from setup-v0.21: VALIDATED payloads carry the chart read.
    "chartread": ("setup",),
