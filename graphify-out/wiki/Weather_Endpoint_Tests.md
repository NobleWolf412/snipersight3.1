...
- **longs' or 'shorts' is the engine's own direction, not a guess.** (1 connections) — `app/tests/test_weather.py`
- **The strip reports the engine AS CONFIGURED, not as shipped.          setups.pl** (1 connections) — `app/tests/test_weather.py`

## Relationships

- [Weather Row Accounting Tests](Weather_Row_Accounting_Tests.md) (12 shared connections)
- [Regime Wording Tests](Regime_Wording_Tests.md) (3 shared connections)
- [TestEveryRowIsAccountedFor](TestEveryRowIsAccountedFor.md) (2 shared connections)
