...
- **OneVerdictCase** (19 connections) — `app/tests/test_quality_one_verdict.py`
- **._record()** (8 connections) — `app/tests/test_quality_one_verdict.py`
...
- **.test_bridge_refresh_cannot_persist_a_competing_verdict()** (2 connections) — `app/tests/test_quality_one_verdict.py`
...
- **.test_forced_cache_refresh_is_not_durable_authority()** (1 connections) — `app/tests/test_quality_one_verdict.py`
- **.test_offline_backfill_cannot_publish_a_scanner_verdict()** (1 connections) — `app/tests/test_quality_one_verdict.py`
