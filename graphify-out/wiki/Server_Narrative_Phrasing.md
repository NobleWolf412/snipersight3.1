...
- **_tf_weather()** (8 connections) — `app/server.py`
- **_regime_label()** (5 connections) — `app/server.py`
- **_play_phrase()** (5 connections) — `app/server.py`
...
- **_regime_plays()** (3 connections) — `app/server.py`
- **_weather_tier()** (3 connections) — `app/server.py`
- **Compact synchronized context strip for the decision workspace.** (1 connections) — `app/server.py`
...
- **The right-hand column: what this condition means, in one sentence.** (1 connections) — `app/server.py`
- **Market Weather — regime per timeframe, and what it means for trading.      One** (1 connections) — `app/server.py`
