...
- **_fees_exclude_funding()** (3 connections) — `app/engine/edgestats.py`
- **_breakeven_fee()** (3 connections) — `app/engine/edgestats.py`
- **_version_spans()** (3 connections) — `app/engine/edgestats.py`
- **_verdict()** (3 connections) — `app/engine/edgestats.py`
- **_fmt()** (3 connections) — `app/engine/edgestats.py`
- **_print_core()** (3 connections) — `app/engine/edgestats.py`
