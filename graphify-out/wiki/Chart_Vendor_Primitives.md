...
- **.test_too_few_symbols_returns_no_interval()** (3 connections) — `app/tests/test_strategy_grade.py`
- **.test_enough_symbols_but_too_few_trades_returns_no_interval()** (3 connections) — `app/tests/test_strategy_grade.py`
- **.test_holm_is_monotone()** (2 connections) — `app/tests/test_strategy_grade.py`
- **.test_untrustworthy_calibration_prints_no_numbers()** (2 connections) — `app/tests/test_strategy_grade.py`
- **.test_rendered_output_is_ascii()** (2 connections) — `app/tests/test_strategy_grade.py`
- **.test_the_correction_caveat_blames_only_what_it_should()** (2 connections) — `app/tests/test_strategy_grade.py`
- **.test_the_traded_set_is_still_only_pullback_and_reversal()** (2 connections) — `app/tests/test_strategy_grade.py`
...
- `app/tests/test_strategy_grade.py`
