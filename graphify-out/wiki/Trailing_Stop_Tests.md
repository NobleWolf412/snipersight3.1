...
- **Risk is 2, trail is 1R: at a best of 110 the stop sits at 108, and         the** (1 connections) — `app/tests/test_manual.py`
...
- [Manual Book Tests](Manual_Book_Tests.md) (12 shared connections)
